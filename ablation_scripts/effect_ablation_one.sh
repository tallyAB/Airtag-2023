...
nohup python ../create_vocab.py  \
 ...
 -t_name /root/AirTag/training_data/AblationOne/train_training_preprocessed_logs_S1-CVE-2015-5122_windows \
 -v_name /root/AirTag/training_data/AblationOne/vocab_training_preprocessed_logs_S1-CVE-2015-5122_windows & 

nohup python ../create_vocab.py  \
 -path /root/AirTag/training_data/AblationOne/training_preprocessed_logs_S2-CVE-2015-3105_windows \
 -t_name /root/AirTag/training_data/AblationOne/train_training_preprocessed_logs_S2-CVE-2015-3105_windows \
 -v_name /root/AirTag/training_data/AblationOne/vocab_training_preprocessed_logs_S2-CVE-2015-3105_windows &

nohup python ../create_vocab.py  \
 -path /root/AirTag/training_data/AblationOne/training_preprocessed_logs_S3-CVE-2017-11882_windows \
 -t_name /root/AirTag/training_data/AblationOne/train_training_preprocessed_logs_S3-CVE-2017-11882_windows \
 -v_name /root/AirTag/training_data/AblationOne/vocab_training_preprocessed_logs_S3-CVE-2017-11882_windows &

nohup python ../create_vocab.py  \
 -path /root/AirTag/training_data/AblationOne/training_preprocessed_logs_S4-CVE-2017-0199_windows_py \
 -t_name /root/AirTag/training_data/AblationOne/train_training_preprocessed_logs_S4-CVE-2017-0199_windows_py \
 -v_name /root/AirTag/training_data/AblationOne/vocab_training_preprocessed_logs_S4-CVE-2017-0199_windows_py &
...
nohup python -u evaluate_onesvm_Sdatasets_ablation_custom.py -flag 1 -nu 0.1 -gama 0.1 -gpu 0 -suffix AblationOne > ../logs/AblationOne/S1.log & wait
nohup python -u evaluate_onesvm_Sdatasets_ablation_custom.py -flag 2 -nu 0.1 -gama 0.15 -gpu 0 -suffix AblationOne > ../logs/AblationOne/S2.log & wait
nohup python -u evaluate_onesvm_Sdatasets_ablation_custom.py -flag 3 -nu 0.1 -gama 0.2 -gpu 0 -suffix AblationOne > ../logs/AblationOne/S3.log & wait
nohup python -u evaluate_onesvm_Sdatasets_ablation_custom.py -flag 4 -nu 0.1 -gama 0.15 -gpu 0 -suffix AblationOne > ../logs/AblationOne/S4.log & wait
